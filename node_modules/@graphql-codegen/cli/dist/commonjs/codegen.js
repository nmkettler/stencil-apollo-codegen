                        ...
                        return new Listr([
                            {
                                ...
                                task: wrapTask(async () => {
                                    ...
                                    const allSchemas = [
                                        ...rootSchemas.map(pointToScehma => load_1.loadSchema(pointToScehma, config)),
                                        ...outputSpecificSchemas.map(pointToScehma => load_1.loadSchema(pointToScehma, config))
                                    ];
                                    if (allSchemas.length > 0) {
                                        outputSchema = core_1.mergeSchemas(await Promise.all(allSchemas));
                                    }
                                }, filename),
                            },
                            {
